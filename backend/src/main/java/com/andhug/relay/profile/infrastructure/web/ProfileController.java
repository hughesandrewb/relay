...
public class ProfileController {
    ...
    public List<WorkspaceDto> getWorkspaces(
        ...
        List<WorkspaceDto> workspaces = workspaceMemberQueryService.getWorkspacesOfProfile(profile.getId());
    ...
    public RoomDto createDirectMessage(
        ...
        var createDirectMessageCommand = CreateDirectMessageCommand.of(profile.getId(), ProfileId.of(request.recipientId()));
    ...
    public ResponseEntity<Void> sendFriendRequest(
        ...
        var sendFriendRequestCommand = SendFriendRequestCommand.builder()
    ...
    public ResponseEntity<Void> acceptFriend(
        ...
        var acceptFriendRequestCommand = AcceptFriendRequestCommand.builder()
