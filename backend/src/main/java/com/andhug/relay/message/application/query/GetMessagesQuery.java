...
public record GetMessagesQuery(UUID roomId, MessageId beforeId, MessageId afterId, int limit) {
   ...
   * @param beforeId the ID of the message to retrieve messages before, mutually exclusive with
   *     afterId
   * @param afterId the ID of the message to retrieve messages after, mutually exclusive with
   *     beforeId
